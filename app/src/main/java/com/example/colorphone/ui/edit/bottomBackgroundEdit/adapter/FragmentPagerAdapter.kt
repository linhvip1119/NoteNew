...
class FragmentPagerAdapter(fragment: Fragment, private var bgClick: (Background) -> Unit) : FragmentStateAdapter(fragment) {

    override fun getItemCount(): Int = 4

    override fun createFragment(position: Int): Fragment = ListBackgroundFragment(position) {
        bgClick(it)
    }
